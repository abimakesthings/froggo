...
def merge(im1, im2, im3, im4) -> Image.Image: #importing image paths
    ...
    h = margin_big + im1.size[1] + margin_big + im2.size[1] + margin_big + im3.size[1] + margin_big + im4.size[1] + margin_big*3 #marginpx gap and margins
    ...
    im.paste(im4, (margin_small, im1.height + im2.height + im3.height + margin_big*4))
